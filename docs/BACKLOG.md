...
- ~~**BL-b90-DEBT-2 (P1, environment):** `upstream/` and `reference_mods/` were **EMPTY** on this machine,
  ...
  **✅ CLOSED 2026-07-28 (branch `fix/debt-tooling`). Closes BL-b89-DEBT-4 too (same defect, filed twice).**
...
- **BL-b89-DEBT-5 (P2, stale gate on a refuted premise)** *(RENUMBERED 2026-07-28 by the
  debt-tooling lane: this entry was filed as a SECOND `BL-b89-DEBT-4`, colliding with the
  upstream-cache item below. Nothing outside this file referenced either id.)*: `MAP-NAV-4` (respawn-shrine +
