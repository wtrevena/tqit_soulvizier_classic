...
**R-70, Will 2026-07-27, verbatim:** "Vashkarr, Eldest of the Ancients soul should get +% pierce
...
today's pre-R-70 shipped state (-8% run speed on all three tiers) and requires the contract to
...
(13 pre-existing + 8 new, headed by the planted pre-R-70 speed-penalty regression).

**LEDGER:** `docs/WILL_RULINGS.md` **R-70** appended VERBATIM, status IMPLEMENTED, in a new
...
**b96 Vashkarr spear-and-shield soul retune (2026-07-28, build57-dev, R-70) - NEW**
...
- **BL-b96-DEBT-4 (P2, ledger gap found in passing):** `apply_svc_patches._apply_b7_eldest_soul_rebalance`
  ...
  physical hits that arent piercing?"), never assigned an R-number. R-70 had to cite it by function
