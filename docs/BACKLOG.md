...
**OPEN DEBT:** BL-b91-DEBT-1..4 (see DEBT REGISTER).
...
**b91 debt-clearance lane, domain `db` (2026-07-28, branch `fix/debt-db`) - NEW**
- **BL-b91-DEBT-1 (P3, new item):** 69 OTHER dangling FX `.dbr` refs across 24 distinct missing
...
- **BL-b91-DEBT-2 (art call, WILL-CONFIRM):** the Emberteeth summon's PET-BAR PORTRAIT is the
...
- **BL-b91-DEBT-3 (needs Will, playtest call):** the BL-ENSLAVER-SPAWNS marauder tankiness fix
...
- **BL-b91-DEBT-4 (launch-gated):** the Emberteeth summon is unproven IN-GAME - the button, its
