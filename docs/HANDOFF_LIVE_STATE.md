# HANDOFF LIVE STATE
> ## BUILD87-DEV DEPLOYED TO DEV (2026-08-12) - R-243 lower soul drop rates (non-fixed 33->20, fixed-location boss 25->10); arz-ONLY. **STEAM UPLOAD PENDING (MAIN SESSION runs upload + push).**
