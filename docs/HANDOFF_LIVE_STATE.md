...
| B | Blood Toxeus main monster doesn't spawn (his blood-demon adds DO) | Prime suspect: proxy difficultyLimitsFile=limit_area002 level bracket filters charLevel-40 main on Normal. Affects BOTH the hub test spawn AND the canonical secret-area spawn (build21 - likely never spawned for anyone). Fix loop RUNNING. | workflow wf_30460e48-ca1 |
...
## 3. RUNNING WORKFLOWS (may complete after this session dies)
