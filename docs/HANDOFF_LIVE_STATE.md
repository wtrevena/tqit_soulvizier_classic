...
> ## 🟡 IN FLIGHT (MERGED TO MAIN 2026-09-10, NOT SHIPPED, NOT DEPLOYED) - R-258 `fix/devourer-soul-drop` + R-259 `fix/backups-to-nas`, both INDEPENDENT-VET GO, integrated as the build102 candidate
...
> deploy is the first real NAS backup run - `BL-R259-DEBT-2` is discharged by it and the ship commit records
