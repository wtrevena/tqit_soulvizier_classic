...
- R-39 [2026-07-16] PENDING (worktree `coldworm-markers` has partials; interrupted lane, joins when
  resumed. STATUS RE-VERIFIED 2026-07-28: `feat/coldworm-uber-markers` IS an ancestor of main, but its
  tip carries only BACKLOG doc commits - none of the Cold Worm buff work. The branch being "merged"
  is NOT evidence this shipped; it did not.) Cold Worm needs ~3x characterLife and +20% armor (`defensiveProtection`) ON TOP of the
