...
## R-250 [2026-08-14] IMPLEMENTED (branch `fix/chest-generosity-shared-cause`) - THE UBER/BOSS CHESTS OPEN THEIR OWN LOOT TABLES AGAIN; THE SECRET PRESENT BOX PAYS 3x. SUPERSEDES the b42 boss-chest standardization.
...
2. **VOLUME.** `svc_loot_volume._r250_exempt` (membership imported from `svc_uber_hoards`, not
...
**DEBT:**
- `BL-R250-DEBT-1` (accepted loss, stated): the retired repoint gave each chest a REGION-banded
...
- `BL-R250-DEBT-2` (WILL DECISION, arz+Text coupled, deliberately NOT taken here to keep this lane
