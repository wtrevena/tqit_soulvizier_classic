...
def main():
    ...
    # --- 2c-r246: DELETED (R-248, 2026-08-14). The R-246 rift-shrine GROUPS emission
    # ('SVCShrineTeleport_R246_*', 2 canonical + up to 11 TESTHUB records) is REVERTED with
    # the whole device wave - Will refuted the devices in-game (WILL_RULINGS R-248; failure
    # graveyard MODDING_PLAYBOOK sec 10/10a). The Duister step above (2c) and every other
    # GROUPS emission are untouched; canonical GROUPS returns to the f9f213b-lineage bytes.
