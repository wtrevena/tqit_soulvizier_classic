...
SOUL_DESIGNS = {
    ...
    # Freezing predator. Blizzard procs when hit. Cold Aura + Freezing Blast augments.
    # Massive cold/frostburn with freeze chance. Fire weakness.
    'uber': {
        ...
        'augmentSkillName2': _FREEZING_BLAST,
        'augmentSkillLevel2': 4,
        'offensiveColdMin': 75.0,
        'offensiveColdMax': 115.0,
        'offensiveSlowColdMin': 55.0,
        'offensiveSlowColdMax': 85.0,
        'offensiveSlowColdDurationMin': 4.0,
        'offensiveFreezeChance': 18.0,
        'offensiveFreezeMin': 2.0,
        'offensiveFreezeMax': 3.0,
        'offensiveColdModifier': 45,
        'characterLifeModifier': 15.0,
        'characterManaModifier': 12.0,
        'characterIntelligenceModifier': 10.0,
        'offensiveTotalDamageModifier': 15,
        'retaliationColdMin': 50.0,
        'retaliationColdMax': 80.0,
        'characterAttackSpeedModifier': 14,
        'characterRunSpeedModifier': 12,
        'characterSpellCastSpeedModifier': 15,
        'defensiveCold': 30.0,
