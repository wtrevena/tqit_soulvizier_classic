...
CONTRACTS = [
    ...
    {'id': 'SOUL-IDENTITY-SHAPE', 'name': 'Ruling-bound soul families keep their designed shape',
     ...
     'derived_from': 'docs/WILL_RULINGS.md - R-70 (Vashkarr spear-and-shield retune, 2026-07-27)'},
]
...
SOUL_IDENTITY_SHAPES = {
    # R-70 (Will, 2026-07-27): "Vashkarr, Eldest of the Ancients soul should get +%
